...
//         setFormData(data => ({ ...data, [name]: value }))
//     }
//     // Ee initPay function frontend lo Razorpay payment process start cheyadaniki use avtundi. Backend nunchi vachchina Razorpay order details teesukoni, Razorpay checkout form open chestundi, user payment complete chesinappudu payment verify chestundi, and success ayithe cart clear chesi /orders page ki redirect chestundi. Let’s break down the code step by step.
